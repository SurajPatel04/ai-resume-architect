...
def prioritize_queue(state: ResumeState) -> Dict[str, Any]:
    """Pure Python deterministic orchestration. Peeks at the top of question_queue and stores
    it in state.active_target. Does NOT pop the item, to ensure it is re-asked if
    validation fails.
    """
